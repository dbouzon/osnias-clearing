...
/**
 * @title OsniasClearing — Osnias USD Clearing (SEI TESTNET — v1)
 *
 * @custom:owner  osnias-clearing
 * @custom:orcid  https://orcid.org/0009-0007-8894-8902
 *
 ...
 *
 * SEI TESTNET — adresses initiales intégrées au contrat.
 * Ne pas utiliser en production sans audit ni remplacement des paramètres de test.
 */
contract OsniasClearing_Orusd is ERC20, Ownable2Step {
    ...
    /// @notice Gestionnaire initial ORUSD sur Sei Testnet.
